...
export default function FeedbackPage() {
  ...
  function handleSend(candidateId: number, managerEmail: string) {
    setSendingId(candidateId);
    // TODO: send managerEmail via your API here
    console.log(`Sending approval summary to manager: ${managerEmail}`);
    setTimeout(() => {
      ...
      <div className="fb-table-wrap">
        <div className="fb-scroll">
          ...
          <div
            className="fb-head"
            style={{
              gridTemplateColumns: `180px 150px repeat(${maxRounds}, minmax(140px, 1fr)) 150px`,
            }}
          >
